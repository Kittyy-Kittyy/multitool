...
def pip_installer():
    try:
        ...
        print(bcolors.RED + 'This tool is only for Debian based systems' + bcolors.RESET)
        print(bcolors.RED + 'Please install the packages manually' + bcolors.RESET)
...
def page_two():
    ...
    print(bcolors.RED + 'ClientForVirusBuilder[11]                   SSH HACKER  [13]' + bcolors.RESET)
    print(bcolors.RED + '------------------------------------------------------------' + bcolors.RESET)
    ...
    if user_input2 == '13':
        os.system('sudo python3 sshHack.py')
